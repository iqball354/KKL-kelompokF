...
Route::middleware(['auth'])->group(function () {
   ...
   Route::get('/warek1/keahlian-dosen', [KeahlianDosenController::class, 'showForWarek1'])->name('warek1.keahlian.show');
   ...
   Route::get('/sdm/keahlian-dosen', [KeahlianDosenController::class, 'showForSDM'])->name('sdm.keahlian.show');
